...
def run_maxrl_replication(
    *,
    ...
    replication_config = build_grpo_1xa100_replication_config(canonical, seed=seed)
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="Run the frozen single-A100 practical-MaxRL seed-replication lane."
    )
